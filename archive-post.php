                    ...
                    <div class="col-sm-12 col-lg-4 mb-5 archive_news_block">
                        <div class="post_image position-relative">
                            <a href="<?php echo get_permalink(); ?>">
                                <?php echo get_the_post_thumbnail(get_the_ID(), 'post_thumbnail', array('class' => 'news_img mb-2', 'loading' => 'lazy')) ?></a>
                            <p class="date"><?php the_time('d-m-Y'); ?></p>
                        </div>

                        <h3 class="h3 text_darkgray"><?php the_title(); ?></h3>
                        <p class="f-26"><?php echo($trimmed_content); ?></p>
                        <a class="btn btn_darkgray readmore no-decoration mx-auto mt-2"
                           href="<?php echo get_permalink(); ?>"><?php _e('Lees meer', 'rebirth'); ?><i
