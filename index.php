...
<section id="header">
   ...
   <p class="side_title_left projects text_gray"><?php _e('Nieuws', 'rebirth'); ?></p>
</section>

<section id="all_news_overview" data-aos="fade-down" data-aos-duration="1500">
	<div class="container">
		<div class="row">										
		<?php
								...
								<?php echo get_the_post_thumbnail( $post_id, 'post_thumbnail', array( 'class' => 'news_img mb-1 ' ) ) ?></a>
